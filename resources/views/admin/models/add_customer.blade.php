<div class="modal fade model_add_customer" id="modal_add_customer" tabindex="-1" role="dialog" aria-labelledby="addBlog" aria-hidden="true">
                    ...
                    <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="laps_cus_name" required value="{{ old('laps_cus_name') }}">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="laps_cus_address" type="text" required value="{{ old('laps_cus_address') }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="laps_cus_phone" type="number" required value="{{ old('laps_cus_phone') }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="laps_cus_mail" type="text" required value="{{ old('laps_cus_mail') }}">
                        ...
                        <div class="col-md-3">
                            <div class="form-group text-center">
                                <input type="file" accept="image/*" id="laps_cus_img_input" name="laps_cus_img" onchange="onFileSelected(event)" class="hidden">
                                <div class="btn-cursor-pointer block-select-image" id="laps_cus_img">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="laps_cus_note" rows="4" required >{{ old('laps_cus_note')}}</textarea>
